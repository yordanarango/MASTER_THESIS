...
"Lectura de Estados"
rf     = open("/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/21_expo_2018/States_PP_NovMar.csv", 'r')
...
ax.set_title(str(Nc)+' States - PP Wind (Nov-Mar)', fontsize=18)

plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/21_expo_2018/Vit_matrix_PP_NovMar_'+str(Nc)+'st.png', bbox_inches='tight', dpi=300)
