...
for k in range(1, NM+1):
    ...
    for i, j in enumerate(pos_nc):
        mes = DATES[j].month
        pr  = file.variables['msl'][j, 88:161, 80:181]/100.

        cc_PR = CICLO_PRESSURE[MESES[mes-1]+'_18'][88:161, 80:181] # Porque los estados se hicieron para la hora de las 18 horas que es cuando se da la mayor velocidad en el día, y fue con lo que se hicieron los HMM
    ...
    path.append('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/20_expo_2018/' + ch + '_CompPressure_JanDec_st'+str(S)+'_HMM'+str(NM)+'_mesoescala')
