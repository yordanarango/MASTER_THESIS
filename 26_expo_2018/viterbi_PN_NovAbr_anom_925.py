...
"Lectura de Estados"
rf     = open("/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/26_expo_2018/States_PN_NovAbr_anom_925.csv", 'r')
...
if Nc == 5:
    ...
    state_matrix[state_matrix == 4] = 22
    state_matrix[state_matrix == 5] = 11
...
if Nc == 6:
    state_matrix[state_matrix == 2] = 66
    state_matrix[state_matrix == 3] = 22
...
ax.set_title(str(Nc)+' States - PN Wind Anomalies (Nov-Abr)', fontsize=18)

plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/26_expo_2018/Vit_matrix_PN_NovAbr_'+str(Nc)+'st_anom_925.png', bbox_inches='tight', dpi=300)
