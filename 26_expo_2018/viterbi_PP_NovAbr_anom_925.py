...
"Lectura de Estados"
rf     = open("/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/26_expo_2018/States_PP_NovAbr_anom_925.csv", 'r')
...
states7 = np.array([int(x[6]) for x in states])
states8 = np.array([int(x[7]) for x in states])
...
states7_new = np.insert(states7, pos_mar1_feb28, np.zeros(len(pos_mar1_feb28)))
states8_new = np.insert(states8, pos_mar1_feb28, np.zeros(len(pos_mar1_feb28)))
...
if Nc == 7:
    state_matrix = np.reshape(states7_new, (len(states7_new)/182, 182))
if Nc == 8:
    state_matrix = np.reshape(states8_new, (len(states8_new)/182, 182))
...
if Nc == 7:
    ...
    state_matrix[state_matrix == 4] = 77
    state_matrix[state_matrix == 5] = 22
    state_matrix[state_matrix == 6] = 44
    state_matrix[state_matrix == 7] = 66

    state_matrix[state_matrix == 22] = 2
    state_matrix[state_matrix == 44] = 4
    state_matrix[state_matrix == 55] = 5
    state_matrix[state_matrix == 66] = 6
    state_matrix[state_matrix == 77] = 7

if Nc == 8:
    state_matrix[state_matrix == 5] = 22
    state_matrix[state_matrix == 2] = 77
    state_matrix[state_matrix == 7] = 88
    state_matrix[state_matrix == 8] = 44
    state_matrix[state_matrix == 4] = 55

    state_matrix[state_matrix == 22] = 2
    state_matrix[state_matrix == 44] = 4
    state_matrix[state_matrix == 55] = 5
    state_matrix[state_matrix == 77] = 7
    state_matrix[state_matrix == 88] = 8
...
if Nc == 7:
    Colors  = [(255/255., 255/255., 255/255.), (255/255., 96/255., 61/255.), (67/255., 173/255., 147/255.), (255/255., 195/255., 0), (88/255., 24/255., 69/255.),
    (11/255., 83/255., 69/255.), (185/255., 97/255., 18/255.), (170/255., 183/255., 184/255.)]
    bounds  = np.array([-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5])
    labelsx = ['ND', '1', '2', '3', '4', '5', '6', '7']


if Nc == 8:
    Colors  = [(255/255., 255/255., 255/255.), (255/255., 96/255., 61/255.), (67/255., 173/255., 147/255.), (255/255., 195/255., 0), (88/255., 24/255., 69/255.),
    (11/255., 83/255., 69/255.), (185/255., 97/255., 18/255.), (170/255., 183/255., 184/255.), (0., 0., 0.)]
    bounds  = np.array([-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5])
    labelsx = ['ND', '1', '2', '3', '4', '5', '6', '7', '8']
...
plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/26_expo_2018/Vit_matrix_PP_NovAbr_'+str(Nc)+'st_anom_925.png', bbox_inches='tight', dpi=300)
