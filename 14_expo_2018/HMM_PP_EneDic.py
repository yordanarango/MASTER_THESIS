...
"Viento"
pos_lon = np.where(lon == -88)[0][0] # Se toma un sólo pixel
pos_lat = np.where(lat == 10.5)[0][0]
...
ax.set_title(str(Nc)+' States - Wind in PP', fontsize=18)

plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/14_expo_2018/Viterbi_matrix_PP_EneDic_'+str(Nc)+'st.png', bbox_inches='tight', dpi=300)
plt.show()

#if Nc == 2: #Para hacer los composites	
#	punto_bin = open('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/13_expo_2018/StimateEstados_HHM2st_EneDic.bin', 'wb')
