...
data <- read.csv(file="/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/16_expo_2018/datos_TT_EneDic.csv"
                 , header=FALSE, sep=",")
...
write.csv(DF, 
          file = "/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/16_expo_2018/States_TT.csv")
