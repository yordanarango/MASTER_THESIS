...
rf     = open("/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/16_expo_2018/States_TT.csv", 'r')
...
ax.set_title(str(Nc)+' States - Wind in TT', fontsize=18)

plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/16_expo_2018/Viterbi_matrix_TT_EneDic_'+str(Nc)+'st.png', bbox_inches='tight', dpi=300)
