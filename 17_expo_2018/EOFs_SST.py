...
def remov_ciclo_v(UyV, LAT, LON, wh, fechas):
    ...
    for l in range(len(wh[0])):
            serie = UyV.variables['sst'][:len(fechas), wh[0][l], wh[1][l]] # Se mete dentro de la función, para sólo ingresar a las series de interés, de lo contrario habría que hacer una lectura de todos los pixeles, procedimiento que es muy pesado para el computador.
            media = []
...
#plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/17_expo_2018/Varianza_explicada.png', dpi=100,bbox_inches='tight')
plt.show()
plt.close('all')
...
ax.set_title('SST EOF-3 [9.61%]', size='15', weight='medium')
plt.show()
...
#
# punto_bin = open('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/17_expo_2018/Dict_PrCo.bin','wb')
