...
# Estado 1
plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_spd[0], Min_spd[0], Max_spd[0], 'm/s', Ttl[0], path[0]+'_individual', C_T='k', wind=True, mapa_u=Comp_u[0], mapa_v=Comp_v[0])
# Estado 2
plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_spd[1], Min_spd[1], Max_spd[1], 'm/s', Ttl[1], path[1]+'_individual', C_T='k', wind=True, mapa_u=Comp_u[1], mapa_v=Comp_v[1])
# Estado 3
plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_spd[2], Min_spd[2], Max_spd[2], 'm/s', Ttl[2], path[2]+'_individual', C_T='k', wind=True, mapa_u=Comp_u[2], mapa_v=Comp_v[2])
