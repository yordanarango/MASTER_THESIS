...
"Lectura de Estados"
rf     = open("/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/24_expo_2018/States_TT_anom_925.csv", 'r')
...
ax.set_title(str(Nc)+' States - TT Wind Anomalies', fontsize=18)

plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/24_expo_2018/Vit_matrix_TT_EneDic_'+str(Nc)+'st_anom_925.png', bbox_inches='tight', dpi=300)
