...
for ch in ['TT', 'PP', 'PN']: #Selección de chorro
	...
	for k in range(1, NM+1):
	    ...
	    path.append('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/25_expo_2018/PR_COMPOSITES/' + DM + '/' + ch + '_CompPressure_NovAbr_st'+str(S)+'_HMM'+str(NM)+'_'+DM+'_anom_925')
	...
	if DM == 'conjunto':
	    ...
	    # Estado 4
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[3], np.min(Min_prs), np.max(Max_prs), 'hPa', Ttl[3], path[3], C_T='k')
	    # Estado 5
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[4], np.min(Min_prs), np.max(Max_prs), 'hPa', Ttl[4], path[4], C_T='k')
	    # Estado 6
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[5], np.min(Min_prs), np.max(Max_prs), 'hPa', Ttl[5], path[5], C_T='k')
	...
	if DM == 'individual':
	    ...
	    # Estado 4
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[3], Min_prs[3], Max_prs[3], 'hPa', Ttl[3], path[3], C_T='k')
	    # Estado 5
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[4], Min_prs[4], Max_prs[4], 'hPa', Ttl[4], path[4], C_T='k')
	    # Estado 6
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[5], Min_prs[5], Max_prs[5], 'hPa', Ttl[5], path[5], C_T='k')

	if DM == 'todos':
	    # Estado 1
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[0], -6.8, 10.2, 'hPa', Ttl[0], path[0], C_T='k')
	    # Estado 2
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[1], -6.8, 10.2, 'hPa', Ttl[1], path[1], C_T='k')
	    # Estado 3
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[2], -6.8, 10.2, 'hPa', Ttl[2], path[2], C_T='k')
	    # Estado 4
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[3], -6.8, 10.2, 'hPa', Ttl[3], path[3], C_T='k')
	    # Estado 5
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[4], -6.8, 10.2, 'hPa', Ttl[4], path[4], C_T='k')
	    # Estado 6
	    plotear(lat[-1], lat[0], lon[0], lon[-1], 4, 7, lon, lat, Comp_prs[5], -6.8, 10.2, 'hPa', Ttl[5], path[5], C_T='k')
