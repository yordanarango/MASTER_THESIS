...
"Lectura de Estados"
rf     = open("/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/25_expo_2018/States_TT_NovAbr_anom_925.csv", 'r')
...
if Nc == 5:
	...
	state_matrix[state_matrix == 5] = 44
	state_matrix[state_matrix == 1] = 55
...
plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/25_expo_2018/Vit_matrix_TT_NovAbr_'+str(Nc)+'st_anom_925.png', bbox_inches='tight', dpi=300)
