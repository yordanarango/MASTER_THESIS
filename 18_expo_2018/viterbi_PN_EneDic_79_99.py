...
my_y_ticks = ['1979', '1980', '', '', '', '1984', '', '', '', '1988', '', '', '', '1992', '', '', '', '1996', '', '', '']
...
ax.set_title(str(Nc)+' States - '+ch+' Wind (79-99)', fontsize=18)

plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/18_expo_2018/Vit_matrix_'+ch+'_EneDic_'+str(Nc)+'st_79_99.png', bbox_inches='tight', dpi=300)
