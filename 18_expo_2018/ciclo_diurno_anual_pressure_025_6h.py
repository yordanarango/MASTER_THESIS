...
archivo = nc.Dataset('.../MSLP_025x025_0x40N_120_55W.nc')
...
CICLO_PRS = ciclo_diurno_anual(prs, DATES, len(lat), len(lon))


punto_bin = open('.../ciclo_diurno_anual_presure_025_6h.bin','wb')
pickle.dump(CICLO_PRS, punto_bin)
punto_bin = open('.../ciclo_diurno_anual_presure_025_6h.bin','wb')
pickle.dump(CICLO_PRS, punto_bin)
