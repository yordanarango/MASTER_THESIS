...
############################# TEHUANTEPEC ###############################################
data <- read.csv(file="/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/22_expo_2018/datos_TT_EneDic_Anomalies.csv"
                 , header=FALSE, sep=",")
...
############################# PAPAGAYO ###############################################
data <- read.csv(file="/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/22_expo_2018/datos_PP_EneDic_Anomalies.csv"
                 , header=FALSE, sep=",")
...
#############################  PANAMA  #############################################
data <- read.csv(file="/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/22_expo_2018/datos_PN_EneDic_Anomalies.csv"
                 , header=FALSE, sep=",")
