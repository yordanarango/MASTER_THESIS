...
for i in normal_years[1:]-1: # 27 años. Se descartan años bisiestos 		# 80-81
	...
	pos = np.where(DATES == pd.Timestamp(str(i)+'-10-01'))[0][0]			# 82-83
																			...
																			# 84-85
	DT.append(DATES[pos:pos+151])											# 85-86
	WND.append(wnd[pos:pos+151])											# 86-87
...
state_matrix = np.reshape(hidden_states, (27, 151))
...
plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/13_expo_2018/Viterbi_matrix_PN_NovMar_'+str(Nc)+'st.png', bbox_inches='tight', dpi=300)
#plt.show()
