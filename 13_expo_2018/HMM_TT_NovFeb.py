...
"Selección de datos en Noviembre, Diciembre, Enero, Febrero"
DT  = [] 
WND = []
...
for i in normal_years[1:]-1: # 27 años. Se descartan años bisiestos 		# 80-81
	...
	pos = np.where(DATES == pd.Timestamp(str(i)+'-10-01'))[0][0]			# 82-83
																			...
																			# 84-85
	DT.append(DATES[pos:pos+120])											# 85-86
	WND.append(wnd[pos:pos+120])											# 86-87
...
plt.savefig('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/13_expo_2018/Viterbi_matrix_PN_NovFeb_'+str(Nc)+'st_prueba.png', bbox_inches='tight', dpi=300)


"Genero Pickle con matríz de estados del HHM con dos estados"
if Nc == 2: #Para hacer los composites	
	punto_bin = open('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/13_expo_2018/StimateEstados_HHM2st_NovFeb.bin', 'wb')
...
if Nc == 3: #Para hacer los composites	
	punto_bin = open('/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/13_expo_2018/StimateEstados_HHM3st_NovFeb.bin', 'wb')
	pickle.dump(state_matrix, punto_bin)
