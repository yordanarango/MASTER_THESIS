...
path  = '/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/5_expo_2017/temperatura_eventos/'
for ch in ['TT', 'PP', 'PN']:
                    ...
                    if cri1 != cri2:
                        ...
                        for Prof in [0, 7, 11]: #superficial, 9.8 metros de prof y 19.4 metros de prof
                            ...
                            for c, f, m in zip(FECHAS_INICIO, FECHAS_FIN, FECHAS_MAX):
                                ...
                                if   ch == 'TT': ST = data_TT[C:F+1, Prof].T
                                elif ch == 'PP': ST = data_PP[C:F+1, Prof].T
                                elif ch == 'PN': ST = data_PN[C:F+1, Prof].T
