...
path  = '/home/yordan/YORDAN/UNAL/TESIS_MAESTRIA/5_expo_2017/mix_layer_depth_resta_maximo+1/'
for ch in ['TT', 'PP', 'PN']:
            ...
            for cri2 in ['MAX', 'MEAN', 'DUR']:
                for perc2 in ['75_100', '50_75', '25_50']:
                    if cri1 != cri2:
                        ...
                        plt.grid(True)
                        plt.savefig(path+ch+'/'+cri1+'/'+ch+'_'+cri1+'_'+perc1+'_'+cri2+'_'+perc2+'.png',dpi=100,bbox_inches='tight')
